...
import convertLead from '@salesforce/apex/ApexConvertController.convertLead';
...
export default class CustomLeadConvert extends LightningElement {
    ...
    handleConvert(event) {
        ...
        convertLead({leadId: this.leadid, ownerId: this.userId })
        .then(result => {
            this.converting = false;
            this.isStep1 = false;
            this.accountid = result.accountId;
            console.log('customLeadConvert.js - convertLead - accountid: ' + this.accountid);
            this.contactid = result.contactId;
            console.log('customLeadConvert.js - convertLead - contactid: ' + this.contactid);
            this.opportunityid = result.opportunityId;
            console.log('customLeadConvert.js - convertLead - opportunityid: ' + this.opportunityid);
